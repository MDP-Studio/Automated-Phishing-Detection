...
moves. The same MCP server also exposes `mailbox_connection_guide`, a safe
setup helper for Gmail, Outlook, Yahoo, iCloud, Zoho, Fastmail, Proton, AOL,
and generic IMAP:
...
See [`docs/mailbox-connection-guide.md`](docs/mailbox-connection-guide.md) for
simple mailbox setup steps, provider-specific IMAP settings, app-password
warnings, and OAuth/admin caveats.
...
| [`docs/mailbox-connection-guide.md`](docs/mailbox-connection-guide.md) | Easy mailbox setup guide for Gmail, Outlook, Yahoo, iCloud, Zoho, Fastmail, Proton, AOL, and generic IMAP |
