...
from src.ml.phishing_classifier import (  # noqa: E402  # agent-quality: allow: scoped lint suppression is required for import order or optional dependency compatibility
    DEFAULT_CORPUS_DIR,
    DEFAULT_MODEL_DIR,
