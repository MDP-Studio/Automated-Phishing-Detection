...
from src.eval.payment_relevance_eval import evaluate_payment_relevance  # noqa: E402  # agent-quality: allow: scoped lint suppression is required for import order or optional dependency compatibility
