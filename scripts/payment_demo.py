...
from src.eval.payment_demo import format_payment_demo_table, run_payment_demo  # noqa: E402  # agent-quality: allow: scoped lint suppression is required for import order or optional dependency compatibility
